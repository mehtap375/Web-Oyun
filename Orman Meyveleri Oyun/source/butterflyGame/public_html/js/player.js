...
Player.onCor = function(e){
    ...
    if(e.objectID == "player"){
        ...
        if(_returnObject.key) {
            ...
            Board.showAlert("Artık bir elmasa sahipsin.", "info");
        ...
        if(_returnObject.enter){
            ...
            if(Player.haveKey > 0){
                ...
                Board.showAlert("Elmasını kullanarak bir kapıyı açtın.", "info");
                
            }else{
                
                Board.showAlert("Kapıdan geçebilmek için elmasa ihtiyacınız var.", "alert");
